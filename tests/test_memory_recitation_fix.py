...
def test_semantic_top_k_capped():
    ...
    from services.engagement.memory import SEMANTIC_TOP_K, SEMANTIC_SEARCH_BUFFER
...
def test_repeat_limit_constants_sane():
    ...
    from services.engagement.session_memory import MEMORY_REPEAT_LIMIT, MEMORY_HISTORY_DEPTH
