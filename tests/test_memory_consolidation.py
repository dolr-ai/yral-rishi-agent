...
def test_merge_threshold_in_reasonable_range():
    ...
    from services.engagement.memory_consolidation import MERGE_DISTANCE_THRESHOLD
...
def test_interval_is_daily():
    ...
    from services.engagement.memory_consolidation import CONSOLIDATION_INTERVAL_SEC
...
def test_initial_delay_avoids_startup_thrash():
    ...
    from services.engagement.memory_consolidation import INITIAL_DELAY_SEC
