...
def test_supports_vision_flag_set_on_all_providers():
    ...
    from services.llm.llm_registry import PROVIDERS
...
def test_user_chat_main_multimodal_in_defaults_with_no_fallback():
    ...
    from services.llm.llm_registry import LLM_DEFAULTS, PROCESS_NAMES
...
def test_has_image_content_detects_openai_style_image_url():
    ...
    from services.llm.llm_registry import has_image_content
...
def test_multimodal_process_not_in_async_never_gemini():
    ...
    from services.llm.llm_registry import ASYNC_PROCESSES_NEVER_GEMINI
