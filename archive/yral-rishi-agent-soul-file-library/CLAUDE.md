# CLAUDE — yral-rishi-agent-soul-file-library
...
- **Service name placeholder:** `yral-rishi-agent-soul-file-library`. The new-service.sh spawner (PR 3, Day 3) replaces this everywhere when generating a real service.
