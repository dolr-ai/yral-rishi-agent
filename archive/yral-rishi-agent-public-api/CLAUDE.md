# CLAUDE — yral-rishi-agent-public-api
...
- **Service name placeholder:** `yral-rishi-agent-public-api`. The new-service.sh spawner (PR 3, Day 3) replaces this everywhere when generating a real service.
