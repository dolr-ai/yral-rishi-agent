# CLAUDE — yral-rishi-agent-new-service-template
...
- **Service name placeholder:** `yral-rishi-agent-new-service-template`. The new-service.sh spawner (PR 3, Day 3) replaces this everywhere when generating a real service.
