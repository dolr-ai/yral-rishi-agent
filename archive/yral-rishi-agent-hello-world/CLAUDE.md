# CLAUDE — yral-rishi-agent-hello-world
...
- **Service name placeholder:** `yral-rishi-agent-hello-world`. The new-service.sh spawner (PR 3, Day 3) replaces this everywhere when generating a real service.
