# CLAUDE — yral-rishi-agent-influencer-and-profile-directory
...
- **Service name placeholder:** `yral-rishi-agent-influencer-and-profile-directory`. The new-service.sh spawner (PR 3, Day 3) replaces this everywhere when generating a real service.
