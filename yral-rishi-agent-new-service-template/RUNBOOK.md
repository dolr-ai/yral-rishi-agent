...
3. Check the Google Chat webhook alert channel for any active P0/P1.
...
2. **Manual** — re-run the deploy workflow with the last-known-good image tag (set as a workflow input). Tag = `ghcr.io/dolr-ai/yral-rishi-agent-new-service-template:<prior-git-sha>`.
...
- `TROUBLESHOOTING.md` — symptom-to-fix table
