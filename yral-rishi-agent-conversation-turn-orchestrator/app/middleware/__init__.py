...
#   adult_content_output_filter.py      — output-side adult_content filter on the handler's response
#
...
# adult_content_output_filter}.py." Splitting also means a future PR that
...
#   adult_content_output_filter.py      — adult_content layer
